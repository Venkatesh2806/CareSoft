...
public class ContactController {
 ...
 public List<Contact> contactdetailsbyemailandrole (@PathVariable String email,@PathVariable String profilerole) throws ServerException {
	   
 	return  contactRepo.getcontactdetilsbyemailandrole(email,profilerole);
 }
}
